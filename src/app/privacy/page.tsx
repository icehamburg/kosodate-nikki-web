    ...
    <>
      ...
      <header className="bg-white border-b border-black/5">
        <div className="max-w-[800px] mx-auto px-6 h-16 flex items-center">
          <Link
            href="/"
            className="flex items-center gap-3 text-[#D97757] font-black text-xl no-underline"
          >
            <span className="w-10 h-10 bg-gradient-to-br from-[#D97757] to-[#FFB088] rounded-xl flex items-center justify-center text-lg">
              📔
            </span>
            子育て日記
          </Link>
      ...
      {/* Content */}
      <main className="py-16 md:py-24 bg-[#FFF9F7]">
        <div className="max-w-[700px] mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <Section title="収集するデータ">
              <ul className="list-disc list-inside space-y-2 text-[#636E72]">
            ...
            <Section title="お問い合わせ">
              <p className="text-[#636E72]">
                ...
                <a
                  ...
                  className="text-[#D97757] font-bold no-underline hover:underline"
                >
            ...
            <p className="mt-12 text-sm text-[#636E72] opacity-60">
              最終更新日: 2025年2月17日
            </p>
          </div>
        </div>
...
function Section({
  ...
  return (
    <div className="mb-8">
      <h2 className="text-lg font-bold text-[#D97757] mb-3">
        {title}
      </h2>
      {children}
    </div>
